...
function coloring() {
    ...
    color.forEach(color => {
        ...
        if (a % 2 == 0) {
            color.style.backgroundColor = 'rgb(255, 228, 75)'
        }
        if (a % 2 !== 0) {
            color.style.backgroundColor = 'rgb(43, 202, 189)'
        }
            ...
            document.querySelectorAll('.box').forEach(i2 => {
                ...
                if (i2.style.backgroundColor == 'green' && i2.innerText.length !== 0) {
                    ...
                    if (a % 2 == 0 && pinkColor == greenColor) {
                        i2.style.backgroundColor = 'rgb(255, 228, 75)'
                    }
                    if (a % 2 !== 0 && pinkColor == greenColor) {
                        i2.style.backgroundColor = 'rgb(43, 202, 189)'
                    }
